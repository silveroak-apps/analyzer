...
@Entity
@Transactional
@Table(name = "buy_analysis")
public class BuyAnalysis {

    private static final long serialVersionUID = -3009157732242241606L;
    private static final Logger logger = LoggerFactory.getLogger(BuyAnalysis.class);
    @Id
    ...
    private Double movingAverageB2;

    @Column(name = "moving_averageb3")
    private Double movingAverageB3;
    ...
    private Double movingAvgTwoHrs;
    ...
    public double getMovingAgv60Min() {
        return movingAgv60Min;
    }

    public void setMovingAgv60Min(double movingAgv60Min) {
        this.movingAgv60Min = movingAgv60Min;
    }
    ...
    public Double getMovingAvgTwoHrs() {
        return movingAvgTwoHrs;
    }

    public void setMovingAvgTwoHrs(Double movingAvgTwoHrs) {
        this.movingAvgTwoHrs = movingAvgTwoHrs;
    }
    ...
    public void copy(CoinStats coinStats) {
        //this.setSignalId(coinStats.getId());
        ...
        this.setMovingAverageB2(coinStats.getMovingAverageUntilLastHalfAnHour());
        this.setMovingAverageB3(coinStats.getMovingAverageUntilLastOneHours());
        this.setMovingAverage30Min(coinStats.getMovingAverage30Min());
        this.setMovingAgv60Min(coinStats.getMovingAgv());
        this.setMovingAvgTwoHrs(coinStats.getMovingAverageUntilLastTwoHours());
    ...
    public Double getMovingAverageB2() {
        return movingAverageB2;
    }

    public void setMovingAverageB2(Double movingAverageB2) {
        this.movingAverageB2 = movingAverageB2;
    }

    public Double getMovingAverageB3() {
        return movingAverageB3;
    }

    public void setMovingAverageB3(Double movingAverageB3) {
        this.movingAverageB3 = movingAverageB3;
    }
        ...
        for (Method method : declaredMethods) {
            if (method.getName().startsWith("get") && !method.getName().endsWith(("List"))) {
                try {
                    ...
                    //LogUtil.printLog(logger, LogUtil.STATUS.ERROR.name(), SignalCatcher.class.getSimpleName(), "Exception while object ", e);
