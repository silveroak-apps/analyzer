 ...
 */
public class SpotBuyAnalyzer extends StrategyAnalyzer implements Runnable {
    private final ApplicationControllers ac;
    Thread spotPositionAnalyzer;
    ...
    public SpotBuyAnalyzer(ApplicationControllers ac, Trader trader) {
        super(trader);
        spotPositionAnalyzer = new Thread(this);
        props = PropertyUtil.getProperties();
        this.ac = ac;
        this.trader = trader;
        spotPositionAnalyzer.start();
    }
