...
@Entity
@Transactional
@Table(name = "COIN_STATS_HISTORY")
public class CoinStatsHistory {
    ...
    public void copy(CoinStats coinStats) {
        ...
        this.setStandardDeviation(coinStats.getStandardDeviation());
        this.setLastSold(coinStats.getLastSold());
        this.setLowest60Min(coinStats.getLowest60Min());
        ...
        this.setTickHigh(coinStats.getTickHigh());
        this.setTickLow(coinStats.getTickLow());
        ...
        this.setExchangeId(coinStats.getExchangeId());
        this.setSymbol(coinStats.getSymbol());
        this.setMarket(coinStats.getMarket());
    ...
    public int getLastMinNegFlow() {
        return lastMinNegFlow;
    }

    public void setLastMinNegFlow(int lastMinNegFlow) {
    ...
    public CoinStats castToCoinStats() {
        CoinStats coinStats = new CoinStats();

        coinStats.setDivDip(this.getDivDip());
        coinStats.setTime(this.getTime());
        coinStats.setBolenAvg(this.getBolenAvg());
        coinStats.setBolenHigh(this.getBolenHigh());
        coinStats.setBolenLow(this.getBolenLow());
        coinStats.setChange45Min(this.getChange45Min());
        coinStats.setCoinScore(this.getCoinScore());
        coinStats.setCurrByBolenger(this.getCurrByBolenger());
        coinStats.setCurrByLowest(this.getCurrByLowest());
        coinStats.setCurrentPrice(this.getCurrentPrice());
        coinStats.setFirstResistance(this.getFirstResistance());
        coinStats.setSecondResistance(this.getSecondResistance());
        coinStats.setFirstSupport(this.getFirstSupport());
        coinStats.setSecondSupport(this.getSecondSupport());
        coinStats.setQuoteVolume(this.getQuoteVolume());
        coinStats.setMarketCap(this.getMarketCap());
        coinStats.setStandardDeviation(this.getStandardDeviation());
        coinStats.setLastSold(this.getLastSold());
        coinStats.setLowest60Min(this.getLowest60Min());
        coinStats.setWaitedAverage(this.getWaitedAverage());
        coinStats.setRSI(this.getRSI());
        coinStats.setSmallEMA(this.getSmallEMA());
        coinStats.setMedEMA(this.getMedEMA());
        coinStats.setLargeEMA(this.getLargeEMA());
        coinStats.setMacdSignalNine(this.getMacdSignalNine());
        coinStats.setMacdSignalList(this.getMacdSignalList());
        coinStats.setEmaLargeList(this.getEmaLargeList());
        coinStats.setEmaMedList(this.getEmaMedList());
        coinStats.setEmaSmallList(this.getEmaSmallList());
        coinStats.setTicType(this.getTicType());
        coinStats.setSignalAnalyzed(this.getSignalAnalyzed());
        coinStats.setMovingAverageUntilLastHalfAnHour(this.getMovingAverageUntilLastHalfAnHour());
        coinStats.setMovingAverageUntilLastOneHours(this.getMovingAverageUntilLastOneHours());
        coinStats.setRejectReason(this.getRejectReason());
        coinStats.setMovingAverage30Min(this.getMovingAverage30Min());
        coinStats.setMovingAgv(this.getMovingAgv());
        coinStats.setTickHigh24Hr(this.getTickHigh24Hr());
        coinStats.setTickLow24Hr(this.getTickLow24Hr());
        coinStats.setTickHigh(this.getTickHigh());
        coinStats.setTickLow(this.getTickLow());
        coinStats.setMovingAverageUntilLastTwoHours(this.getMovingAverageUntilLastTwoHours());
        coinStats.setLastMinNegFlow(this.getLastMinNegFlow());
        coinStats.setPriceMovementPercent(this.getPriceMovementPercent());
        coinStats.setExchangeId(this.getExchangeId());
        coinStats.setSymbol(this.getSymbol());
        coinStats.setMarket(this.getMarket());
        coinStats.setEma5(this.getEma5());
        coinStats.setEma10(this.getEma10());
        coinStats.setEma20(this.getEma20());
        coinStats.setEma30(this.getEma30());
        coinStats.setEma50(this.getEma50());
        coinStats.setEma100(this.getEma100());
        coinStats.setEma200(this.getEma200());

        coinStats.setSma5(this.getSma5());
        coinStats.setSma10(this.getSma10());
        coinStats.setSma20(this.getSma20());
        coinStats.setSma30(this.getSma30());
        coinStats.setSma50(this.getSma50());
        coinStats.setSma100(this.getSma100());
        coinStats.setSma200(this.getSma200());
